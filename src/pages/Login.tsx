    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center w-32 h-24 rounded-full bg-white shadow-lg mx-auto mb-6 border-4 border-blue-100">
            <img src={`/logo.svg?v=${Date.now()}`} alt="Logo" className="w-28 h-20 object-contain" />
          </div>
