...
class ApiService {
  ...
  async createUser(user: { username: string; email: string; password: string; role?: string }): Promise<any> {
  ...
  async updateUser(id: number, user: { username: string; email: string; password?: string; role: string }): Promise<any> {
